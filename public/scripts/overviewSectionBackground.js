    ...
    h = (function () {
      function h(i) {
        ...
        _cccccccccc(this, h),
          ...
          this.c.setAttribute("id", "overview-canvas"),
        ...
        _ooooo(h, [
          {
            key: "gr",
            value: function (t) {
              const i = document.getElementsByClassName(t || "overview-header");
              if (!i.length)
                throw new Error("No .overview-header element found");
              return i[0];
            },
          },
          {
