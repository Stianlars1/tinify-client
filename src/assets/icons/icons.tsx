...
export const ImagePreviewIcon = ({ className, size }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const MobileIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const CompressIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const AspectRatioIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const ArrowsExpandIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const ComputerIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const MoneyIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const AdjustmentIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <AdjustmentsHorizontalIcon
        width={size}
...
export const EyeIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <Eye width={size} height={size} className={className} />
    </>
  );
};
export const ShieldCheckIcon = ({ className, size }: IconProps) => {
  return (
    <>
      <Shield width={size} height={size} className={className} />
    </>
  );
};
