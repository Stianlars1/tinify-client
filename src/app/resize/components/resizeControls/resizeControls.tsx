...
import {CustomInput, CustomInputLabel, CustomInputWrapper,} from "@/components/ui/form/customInput/customInput";
...
export const ResizeControls = ({
  ...
  const updateFileStatus = (fileName: string, updates: Partial<ProcessingStatus>) => {
                ...
                <>
                  ...
                  <CustomInputWrapper>
                    ...
                    <CustomInput
                        ...
                        type="number"
                        value={height}
                        placeholder={keepAspectRatio && width !== undefined && width !== "" ? "auto" : ""}
                        onFocus={() => setScale("")}
                        onChange={(e) => {
                ...
                <CustomInputWrapper>
                  ...
                  <CustomInput
                      ...
                      onChange={(e) => {
                        ...
                        setScale(e.target.value === "" ? "" : parseFloat(e.target.value));
                      }}
                  />
                </CustomInputWrapper>
            )}
...
{/*            {Object.values(processingStatuses).map(status => (
            ...
            <button
                ...
                disabled={loading}
            >
              {loading ? 'Processing...' : (images.length > 1 ? "Resize Images" : "Resize image")}
            </button>
          </form>
        </div>
      </>
